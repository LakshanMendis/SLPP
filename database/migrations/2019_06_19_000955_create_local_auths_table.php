...
class CreateLocalAuthsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('master_local_auths', function (Blueprint $table) {
        ...
        DB::table('master_local_auths')->insert([
            'id' => 1,
            'district_id' => 1,
            'name' => 'Undefined',
            'name_en' => 'Undefined',
    ...
    {
        Schema::dropIfExists('master_local_auths');
    }
}
