...
class CreateGramasevasTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('master_gramasevas', function (Blueprint $table) {
        ...
        DB::table('master_gramasevas')->insert([
            'id' => 1,
            'ward_id' => 1,
            'name' => 'Undefined',
            'name_en' => 'Undefined',
    ...
    {
        Schema::dropIfExists('master_gramasevas');
    }
}
