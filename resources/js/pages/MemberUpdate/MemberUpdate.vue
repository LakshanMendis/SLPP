<template>
  <div>
    <b-breadcrumb>
      ...
      <b-breadcrumb-item active>Update Member</b-breadcrumb-item>
    </b-breadcrumb>
    <h1 class="page-title">
      Member - <span class="fw-semi-bold">Update</span>
    </h1>
              ...
              <tbody>
                <tr v-for="row in tableStyles" :key="row.id">
                  ...
                  <td class="width-150" align="center">
                    <b-button size="sm" variant="maroon" v-b-modal.modal-1><i class="fa fa-pencil"></i></b-button>
                  </td>
                </tr>
              </tbody>
            </table>
    ...
    <b-modal id="modal-1" size="xl" title="Member Update">
      <b-tabs content-class="mt-3">
        <b-tab title="Personal" active>
          <b-row>
